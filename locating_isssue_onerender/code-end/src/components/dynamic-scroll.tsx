...
const DynamicScroll = ({ content }: { content: ReactNode }) => {
  ...
  return (
    <ScrollableContainer onScroll={handleScroll}>
      ...
      {/* this content is not rerender here as thease contens components are passed as props normally react doesnt re render when the props change  */}
      {/* we can use children instead of content */}
      {content}
    </ScrollableContainer>
  );
};
